...
// import { createUUID, formatTimeWithMS } from "../../packages/utils/util";
...
//     this.CONTENT = content;
//     this.NO_DATA_ALERT = content.getElementsByClassName("tab-centered")[0] as HTMLElement;
//     this.HEADER_TEMPLATE = content.getElementsByClassName("dash-table-header-template")[0] as HTMLElement;
//     this.TABLE_CONTAINER = content.getElementsByClassName("dash-table-container")[0] as HTMLElement;
//     this.TABLE_BODY = content.getElementsByClassName("dash-table")[0].firstElementChild as HTMLElement;
//     this.DRAG_HIGHLIGHT = content.getElementsByClassName("dash-table-drag-highlight")[0] as HTMLElement;
//     this.INPUT_FIELD = content.getElementsByClassName("dash-table-jump-input")[0] as HTMLInputElement;
...
//     });
//     content.getElementsByClassName("dash-table-jump-button")[0].addEventListener("click", jump);
//   }
